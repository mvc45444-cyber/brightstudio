            ...
            <form className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                 <div>
                   ...
                   <input 
                     type="text" 
                     className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all placeholder:text-slate-400" 
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all text-slate-600">
              ...
              <div>
                ...
                <textarea 
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none h-40 resize-none transition-all placeholder:text-slate-400" 
                  placeholder="How can we help you today?"
                ></textarea>
              </div>

              <button type="button" className="w-full bg-amber-600 text-white font-bold text-lg py-4 rounded-xl hover:bg-amber-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                Send Message
              </button>
