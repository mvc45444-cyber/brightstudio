...
export const metadata = {
  title: 'All Software Reviews | Bright Studio',
    ...
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <section className="bg-white border-b border-slate-200 py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 text-center max-w-4xl">
           <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-50 text-amber-700 text-sm font-medium mb-6 border border-amber-100">
             <BookOpen className="w-4 h-4" />
             Library
           </div>
           <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">
             All Software <span className="text-amber-600">Reviews</span>
           </h1>
           <p className="text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl mx-auto">
             Our complete collection of in-depth software reviews. We test tools rigorously so you don't have to.
           </p>
        </div>
      </section>
                ...
                <div className="p-6 flex flex-col h-full">
                   <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center gap-3">
                         <div className="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center text-amber-600 font-bold text-xl">
                            {software.productName.charAt(0)}
                         </div>
                         <div>
                            <h3 className="font-bold text-slate-900 text-lg group-hover:text-amber-600 transition-colors">{software.productName}</h3>
